	...
	$(document)
			.ready(
					function() {
						...
						$.ajax({
									url : "${pageContext.request.contextPath}/rest/detail?idx="
											+ postIdx,
									type : 'GET',
									success : function(data) {
										...
										var pcontent = '<pre>' + data.p_content
												+ '</pre>';
										...
										if (data.p_loc != "") {
											...
											plocHtml += '<span class="location" style="margin-left: 5px;">'
													+ data.p_loc + '</span>';
						...
						$
								.ajax({
									...
									url : "${pageContext.request.contextPath}/rest/detail/image?idx="
											+ postIdx,
									type : 'post',
									success : function(data) {
	...
	function loadComment() {
		...
		$
				.ajax({
					...
					url : "${pageContext.request.contextPath}/rest/cmt/select?PostNO="
							+ postIdx,
					type : 'get',
					data : {
						"postIdx" : postIdx
